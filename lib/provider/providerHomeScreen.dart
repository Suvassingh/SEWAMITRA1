    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon (Icons.calendar_month),label: "Booked Services"),
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          stops: [0.0, 0.8, 1.3, 1.0], // Transition at 30% of height
        ),
      ),
      child: SafeArea(
      ...
      child: InkWell(
        ...
        onTap:
            () => Navigator.push(
              ...
              MaterialPageRoute(
                builder:
                    (context) => ServiceRegistrationScreen(service: service),
              ),
            ),
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              // Image with constrained size
                ...
                Image.asset(service.imageAssets,height: 40,
...
class _ServiceRegistrationScreenState extends State<ServiceRegistrationScreen> {
  ...
  Future<void> _submitRegistration() async {
    ...
    try {
      ...
      final newServiceRef =
          _dbRef.child('providers/${user.uid}/services').push();
      ...
      await newServiceRef.set({
        ...
        'price_description':
            _priceType == 'Custom' ? _priceDescriptionController.text : null,
        'location': {
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: const [
                ...
                DropdownMenuItem(
                  value: 'Custom',
                  child: Text('Custom Description'),
                ),
              ],
              onChanged: (val) => setState(() => _priceType = val),
              validator:
                  (val) => val == null ? 'Please select a pricing type' : null,
            ),
            const SizedBox(height: 15),
            ...
            if (_relatedWorkImage != null)
              ...
              const Text(
                'No related work image selected',
                style: TextStyle(
                  color: Colors.black,
                  fontWeight: FontWeight.bold,
                ),
